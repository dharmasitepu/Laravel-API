# Adaptive Network LAB Website Backend [Lumen]
   with Lumen for Backend API. 
   VPS : [https://go.bignetlab.com/posts]
   
   CPANEL : [https://api.gbesar.com/posts]
...
5. Go to the adaptivenetlab-lumen directory
6. Edit the configuration database in the .env file in the adaptivenetlab-lumen directory 
